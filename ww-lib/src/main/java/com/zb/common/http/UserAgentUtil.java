...
public class UserAgentUtil {
	...
	public static UserAgent getUserAgent(String ua) {
		...
		if (userAgent.contains("ANDROID")) {
			...
			if (userAgent.contains("IPHONE")) {
				...
				osVer = userAgent.substring(userAgent.indexOf("MAC OS X") + 9,
						userAgent.indexOf(")"));
			}
			return judgeBrowser(ua, os, osVer,devType,netType);
	 ...
	 * @return
	 */
	private static UserAgent judgeBrowser(String userAgent, String os,
			String osVer, String devType,String netType) {
		if (userAgent.contains("Chrome")) {
			...
			return new UserAgent("Chrome", chromeVersion, os, osVer, userAgent,
					devType,netType);
			...
			return new UserAgent("Safari", chromeVersion, os, osVer, userAgent,
					devType,netType);
			...
			return new UserAgent("Firefox", ffVersion, os, osVer, userAgent,
					devType,netType);
			...
			if (userAgent.indexOf("rv:") > 0) {
				v = userAgent.substring(userAgent.indexOf("rv:") + 3,
						userAgent.indexOf("rv:") + 7);
			}
	...
	public static void main(String[] args) {
		System.out
				.println(UserAgentUtil
						.getUserAgent("Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; Trident/6.0)"));

		System.out
				.println(UserAgentUtil
						.getUserAgent("Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/25.0.1364.152 Safari/537.22"));
		System.out
				.println(UserAgentUtil
						.getUserAgent("Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.71 Safari/537.36"));
		System.out
				.println(UserAgentUtil
						.getUserAgent("Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; Trident/6.0)"));
		System.out
				.println(UserAgentUtil
						.getUserAgent("Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.122 Safari/537.36 SE 2.X MetaSr 1.0"));
		System.out
				.println(UserAgentUtil
						.getUserAgent("Mozilla/5.0 (Linux; U; Android 4.3; zh-cn; Lenovo S810t Build/JLS36C) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30"));
		System.out
				.println(UserAgentUtil
						.getUserAgent("Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; Trident/6.0)"));
		System.out
				.println(UserAgentUtil
						.getUserAgent("Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36"));
		System.out
				.println(UserAgentUtil
						.getUserAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11) AppleWebKit/601.1.56 (KHTML, like Gecko) Version/9.0 Safari/601.1.56"));
		System.out
				.println(UserAgentUtil
						.getUserAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36 Edge/12.10240 "));
		System.out
				.println(UserAgentUtil
						.getUserAgent("Mozilla/5.0 (iPhone; CPU iPhone OS 7_0_4 like Mac OS X) AppleWebKit/537.51.1 (KHTML, like Gecko) Version/7.0 Mobile/11B554a Safari/9537.53"));
	}
}
