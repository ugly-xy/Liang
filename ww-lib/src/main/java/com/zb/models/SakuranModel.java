...
@Document
public class SakuranModel extends AbstractDocument {
	...
	private Set<SakuranUserVO> uas = new HashSet<>();// 本轮用户
	...
	public Set<SakuranUserVO> getUas() {
		return uas;
	}

	public void setUas(Set<SakuranUserVO> uas) {
		this.uas = uas;
	}
