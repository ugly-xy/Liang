...
import com.qq.open.org.json.JSONObject;
import com.qq.open.org.json.JSONException;
...
public class OpenApiV3
{
     ...
     * @param protocol HTTP请求协议 "http" / "https"a
     * @return 返回服务器响应内容
     */
    public static String api(String scriptName, HashMap<String, String> params) throws OpensnsException
    {
