...
@Document
public class GameCP extends AbstractDocument {
	...
	public GameCP(Long id, Integer status, Integer sort, long adminId,
	...
	private int isUnionSecret;  // 1 统一 2各个App分别使用自己的独立签名
