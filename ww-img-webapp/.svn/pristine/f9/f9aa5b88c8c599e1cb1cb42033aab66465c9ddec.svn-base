...
public class JiPiaoGuoNeiTool extends BaseTool {

	public JiPiaoGuoNeiTool(StorageService storageService) {
	...
	public static void main(String[] args) throws IOException {
		...
		JiPiaoGuoNeiTool tyt = new JiPiaoGuoNeiTool(storageService);
		tyt.isDebug(true);
