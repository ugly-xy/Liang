...
public class LiHunZhengTool extends BaseTool {

	public static void main(String[] args) throws IOException {
		String tmpPath = "http://imgzb.zhuangdianbi.com/56f0ed5393b071409286d7f2";
	...
	public LiHunZhengTool(StorageService storageService) {
