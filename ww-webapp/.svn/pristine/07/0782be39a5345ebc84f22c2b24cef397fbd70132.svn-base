...
import com.zb.service.SmsService;
...
public class AuthCtl extends BaseCtl {
	...
	// public ReMsg register(String username, String pwd, HttpServletRequest
	// req) {
	...
	// }
	// return authService.reg(username, pwd, req);
	// }
	...
	public ReMsg islogin(String token, String lbs, String channelId, Integer channelType, String appCode,
		...
		if (StringUtils.isNotBlank(channelId)) {// cid不为空
			pushService.savePushChannel(channelId, channelType, appCode, req);
		}
