...
//	private String[] godPics; // 神评论图片集
	...
	public Article(Long id, int type, String title, String content, String cover, long userId, String[] tags,
			int status, int essence, int audited, double sort, long adminId, Long groupId, 
			int anonymous, Long topicId, String topic, Long publishTime, String summary,
			Integer pri) {
