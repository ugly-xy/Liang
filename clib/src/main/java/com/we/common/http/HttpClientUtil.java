...
public abstract class HttpClientUtil {
	...
	public static void main(String[] args) throws Exception {
		MessageUpdate mu = new MessageUpdate();
		mu.setUpdate_id(1);
		String json= JSONUtil.beanToJson(mu);
		String result = HttpClientUtil.postXml("http://localhost:8080/telegram/webhook/dafie2nkdafdscadsfjads", json);
