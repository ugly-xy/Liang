...
class Api_Video extends PhalApi_Api {
	...
	public function getRules() {
		return array(
			...
			'lookVideo'=>array(
				'uid' => array('name' => 'uid', 'type' => 'int', 'require' => true, 'desc' => '用户ID'),
            	'token' => array('name' => 'token', 'type' => 'string', 'min' => 1, 'require' => true, 'desc' => 'token'),
            	'status' => array('name' => 'status', 'type' => 'int', 'require' => true, 'desc' => '状态 1开始 2结束'),
			)
		);
	}
	...
	public function report() {
        $rs = array('code' => 0, 'msg' => T('举报成功'), 'info' => array());
	...
	public function lookVideo() {
        ...
        $domain = new Domain_Video();
        $info = $domain->lookVideo($uid,$status);
		$rs['info']=$info;
