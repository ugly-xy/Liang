...
class Api_Login extends PhalApi_Api { 
	public function getRules() {
        return array(
			...
			'userReg' => array(
                ...
                'invite' => array('name' => 'invite', 'type' => 'string',  'desc' => '邀请码'),
            ),
			'userFindPass' => array(
                'user_login' => array('name' => 'user_login', 'type' => 'string', 'min' => 1, 'require' => true,  'min' => '6',  'max'=>'30', 'desc' => '账号'),
				'user_pass' => array('name' => 'user_pass', 'type' => 'string', 'min' => 1, 'require' => true,  'min' => '1',  'max'=>'30', 'desc' => '密码'),
   ...
   /**
    ...
    public function codeLogin() {
        ...
        $domain = new Domain_Login();
        $info = $domain->codeLogin($user_login,$source);
	...
	public function isreg() {
		...
		$res=DI()->notorm->users_weight_info->where('uid=? and addtime=?',$uid,$today)->fetchOne();
		$info['isreg']='1';
		if(!$res || $res['signin']==0){
			$info['isreg']='0';
		}
