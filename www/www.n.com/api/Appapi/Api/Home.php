...
class Api_Home extends PhalApi_Api {  
    ...
    public function getConfig() {
        ...
        $info['min_ratio']=$info_pri['min_ratio']; //代币兑换人民币比例
		
        $info['min_withdraw']=$info_pri['min_withdraw']; //最小提现数量
        $info['min_withdraw_fee']=$info_pri['min_withdraw_fee']; //最低提现手续费
        $info['fast_fee']=$info_pri['fast_fee']; //提现加速费用
        $info['minimum_fee_percentage']=$info_pri['minimum_fee_percentage']; //超过最低提现手续费按%来提取
        $info['withdraw_fee_type']=$info_pri['withdraw_fee_type']; //超过最低提现手续费按%来提取
