...
class Api_Guard extends PhalApi_Api {
	...
	public function getList() {
        ...
        $privilege=array(
            array('title'=>T('身份标识'),'des'=>T('聊天区显示守护身份标识'),'thumb_c'=>get_upload_path('/public/guard/guard_1.png'),'thumb_g'=>get_upload_path('/public/guard/guard_0.png')),
            array('title'=>T('进场特效'),'des'=>T('拥有进场金光以及专属欢迎语'),'thumb_c'=>get_upload_path('/public/guard/enter_c.png'),'thumb_g'=>get_upload_path('/public/guard/enter_g.png')),
            array('title'=>T('专属礼物'),'des'=>T('拥有直播间守护用户才可以送出的专属礼物'),'thumb_c'=>get_upload_path('/public/guard/gift_c.png'),'thumb_g'=>get_upload_path('/public/guard/gift_g.png')),
            array('title'=>T('尊贵特权'),'des'=>T('防止除主播外的其他人踢出禁言'),'thumb_c'=>get_upload_path('/public/guard/privilege_c.png'),'thumb_g'=>get_upload_path('/public/guard/privilege_g.png')),
        );
