...
return array(
    ...
    'Qiniu' =>  array(
        //统一的key
        'accessKey' => 'S4t9HY4RojhIPJXeoAnAOkEluzRxNFsmzFPSXeXO',
        'secretKey' => 'rqrMoLWiyRNRcBgNFYgDIZNaNE9skFnncdWKxEFb',
        //自定义配置的空间
        'space_bucket' => 'kr_wet',
        'space_host' => 'http://qiniu2.tencentcdn.com',
    ...
    'UCloud' => array(
        //对应的文件路径
        'host' => 'http://www.tencentcdn.com/api/upload' 
    ),
