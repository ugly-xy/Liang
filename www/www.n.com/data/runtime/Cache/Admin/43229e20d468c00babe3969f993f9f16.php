...
.hide{
			...
			<div class="js-tabs-content">
				...
				<div>
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label">礼物抽成</label>
							<div class="controls">				
								<input type="text" name="post[gift_pumping]" value="<?php echo ($config['gift_pumping']); ?>"> 礼物抽成（整数 %）
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">填写邀请码(注册用户所得奖励)</label>
							<div class="controls">				
								<input type="text" name="post[uid_currency]" value="<?php echo ($config['uid_currency']); ?>"> 整数
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">填写邀请码(注册对方所得奖励)</label>
							<div class="controls">				
								<input type="text" name="post[touid_currency]" value="<?php echo ($config['touid_currency']); ?>"> 整数 
							</div>
						</div>
					</fieldset>
				</div>
					...
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">				
								...
								<label class="checkbox inline">短信验证码开关,关闭后则无法接收短信</label>
							</div>
						</div>
                        <div class="control-group">
				...
				<div>
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label">广告视频开关</label>
							<div class="controls">
										
								<label class="radio inline"><input type="radio" value="0" name="post[ad_video_switch]" <?php if(($config['ad_video_switch']) == "0"): ?>checked="checked"<?php endif; ?>>关</label>
								<label class="radio inline"><input type="radio" value="1" name="post[ad_video_switch]" <?php if(($config['ad_video_switch']) == "1"): ?>checked="checked"<?php endif; ?>>开</label>
						...
						<div class="control-group">
							<label class="control-label">滑动几个视频出现广告</label>
							<div class="controls">				
								<input type="text" name="post[video_ad_num]" value="<?php echo ($config['video_ad_num']); ?>" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');"> 请从1,2,4,5,10,20中选择一个填写
							</div>
						</div>
				...
				<div>
					<fieldset>
						<!--
						<div class="control-group">
							<label class="control-label">代币名称</label>
							<div class="controls">				
									<input type="text" name="post[token_name]" value="<?php echo ($config['token_name']); ?>"> 
							</div>
						</div>-->
						<div class="control-group">
							<label class="control-label">代币精度</label>
							<div class="controls">				
									<input type="text" name="post[token_decimal]" value="<?php echo ($config['token_decimal']); ?>"> 
									<span class="form-required">*</span>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">代币比例</label>
							<div class="controls">				
									<input type="text" name="post[min_ratio]" value="<?php echo ($config['min_ratio']); ?>"> 
									<span class="form-required">*(1代币等于多少人民币)</span>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">平台地址</label>
							<div class="controls">				
									<input type="text" name="post[plat_address]" value="<?php echo ($config['plat_address']); ?>"> 
									<span class="form-required">*</span>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">最小充币数量</label>
							<div class="controls">				
									<input type="text" name="post[min_recharge]" value="<?php echo ($config['min_recharge']); ?>"> 
									<span class="form-required">*</span>
									<?php echo ($config['token_name']); ?>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">最小提现数量</label>
							<div class="controls">				
									<input type="text" name="post[min_withdraw]" value="<?php echo ($config['min_withdraw']); ?>"> 
									<span class="form-required">*</span>
									<?php echo ($config['token_name']); ?>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls"> 
								<label style="display: inline-block;"><input type="radio"  style="vertical-align:middle; margin-top:0;"    name="post[withdraw_fee_type]" value="0"  <?php if($config['withdraw_fee_type'] == 0): ?>checked<?php endif; ?> >  固定值</label>
								<label style="display: inline-block;"><input type="radio"  style="vertical-align:middle; margin-top:0;"   name="post[withdraw_fee_type]" value="1"  <?php if($config['withdraw_fee_type'] == 1): ?>checked<?php endif; ?> > 百分比</label>
							</div>	
						</div>
						<div class="control-group">
							<label class="control-label">提现手续费（固定值）</label>
							<div class="controls">				
								<input type="text" name="post[min_withdraw_fee]"   value="<?php echo ($config['min_withdraw_fee']); ?>" <?php if($config['withdraw_fee_type'] == 1): ?>readonly<?php endif; ?> > 
									<span class="form-required">*</span>
									<?php echo ($config['token_name']); ?>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">提现手续费（百分比）</label>
							<div class="controls">				
									<input type="text" name="post[minimum_fee_percentage]"  value="<?php echo ($config['minimum_fee_percentage']); ?>" <?php if($config['withdraw_fee_type'] == 0): ?>readonly<?php endif; ?>   > 
									<span class="form-required">*(整数 %)</span>
									<?php echo ($config['token_name']); ?>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">提现加速费用</label>
							<div class="controls">				
									<input type="text" name="post[fast_fee]" value="<?php echo ($config['fast_fee']); ?>"> 
									<span class="form-required">*</span>
									<?php echo ($config['token_name']); ?>
							</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label">提现ETH费用</label>
							<div class="controls">				
									<input type="text" name="post[gas_price]" value="<?php echo ($config['gas_price']); ?>"> 
									<span class="form-required">*</span>
									GWEI
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">提现加速ETH费用</label>
							<div class="controls">				
									<input type="text" name="post[gas_fast_price]" value="<?php echo ($config['gas_fast_price']); ?>"> 
									<span class="form-required">*</span>
									GWEI
							</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label">提币默认通道</label>
							<div class="controls">				
									<input type="text" name="post[withdraw_gateway]" value="<?php echo ($config['withdraw_gateway']); ?>"> 
									<span class="form-required">*</span> 注意以/结尾	 
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">提币通道一</label>
							<div class="controls">				
									<input type="text" name="post[withdraw_gateway1]" value="<?php echo ($config['withdraw_gateway1']); ?>"> 
									<span class="form-required">*</span> 注意以/结尾	 
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">提币通道二</label>
							<div class="controls">				
									<input type="text" name="post[withdraw_gateway2]" value="<?php echo ($config['withdraw_gateway2']); ?>"> 
									<span class="form-required">*</span> 注意以/结尾	 
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">订单查询接口地址</label>
							<div class="controls">				
									<input type="text" name="post[ethscan_gateway]" value="<?php echo ($config['ethscan_gateway']); ?>"> 
									<span class="form-required">*</span> 注意以/结尾	 
							</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label">充值接口</label>
							<div class="controls">				
									<input type="text" name="post[recharge_gateway]" value="<?php echo ($config['recharge_gateway']); ?>"> 
									<span class="form-required">*</span> 注意以/结尾	 
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">充值手续费</label>
							<div class="controls">				
									<input type="text" name="post[recharge_gas]" value="<?php echo ($config['recharge_gas']); ?>"> 
									<span class="form-required">*</span> GWEI	 
							</div>
						</div>
							<div class="control-group">
							<label class="control-label">汇总接口</label>
							<div class="controls">				
									<input type="text" name="post[transfer_gateway]" value="<?php echo ($config['transfer_gateway']); ?>"> 
									<span class="form-required">*</span>  注意以/结尾 
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">汇总地址</label>
							<div class="controls">				
									<input type="text" name="post[transfer_address]" value="<?php echo ($config['transfer_address']); ?>"> 
									<span class="form-required">*</span>  
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">汇总手续费</label>
							<div class="controls">				
									<input type="text" name="post[transfer_gas]" value="<?php echo ($config['transfer_gas']); ?>"> 
									<span class="form-required">*</span> GWEI
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">汇总下限</label>
							<div class="controls">				
									<input type="text" name="post[transfer_limit]" value="<?php echo ($config['transfer_limit']); ?>"> 
									<span class="form-required">*</span> 超过该值进行自动汇总
							</div>
						</div>
				...
				<div>
					<fieldset>
						<div class="control-group">
							<label class="control-label">消费-送礼物</label>
							<div class="controls">				
								<input type="text" name="post[expend_gift]" value="<?php echo ($config['expend_gift']); ?>"> 消费-送礼物(整数 %)
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">消费-房间扣费</label>
							<div class="controls">				
								<input type="text" name="post[expend_room]" value="<?php echo ($config['expend_room']); ?>"> 消费-房间扣费(整数 %)
							</div>
						</div>
                        
                        <div class="control-group">
							<label class="control-label">消费-直播间内红包</label>
							<div class="controls">				
								<input type="text" name="post[expend_redenvelopes]" value="<?php echo ($config['expend_redenvelopes']); ?>"> 消费-直播间内红包(整数 %)
							</div>
						</div>
                       
						
						<div class="control-group">
							<label class="control-label">消费-直播间内弹幕</label>
							<div class="controls">				
								<input type="text" name="post[expend_barrage]" value="<?php echo ($config['expend_barrage']); ?>"> 消费-直播间内弹幕(整数 %)
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">消费-直播间购买守护</label>
							<div class="controls">				
								<input type="text" name="post[expend_guard]" value="<?php echo ($config['expend_guard']); ?>"> 消费-直播间购买守护(整数 %)
							</div>
						</div>
						
						<!--<div class="control-group">
							<label class="control-label">消费-购买靓号</label>
							<div class="controls">				
								<input type="text" name="post[expend_liang]" value="<?php echo ($config['expend_liang']); ?>"> 消费-购买靓号(整数 %)
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">消费-购买坐骑</label>
							<div class="controls">				
								<input type="text" name="post[expend_car]" value="<?php echo ($config['expend_car']); ?>"> 消费-购买坐骑(整数 %)
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">消费-购买VIP</label>
							<div class="controls">				
								<input type="text" name="post[expend_vip]" value="<?php echo ($config['expend_vip']); ?>"> 消费-购买VIP(整数 %)
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">消费-分销</label>
							<div class="controls">				
								<input type="text" name="post[expend_distribution]" value="<?php echo ($config['expend_distribution']); ?>"> 消费-分销(整数 %)
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">消费-家族</label>
							<div class="controls">				
								<input type="text" name="post[expend_family]" value="<?php echo ($config['expend_family']); ?>"> 消费-家族(整数 %)
							</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label">消费-游戏</label>
							<div class="controls">				
								<input type="text" name="post[expend_game]" value="<?php echo ($config['expend_game']); ?>"> 消费-游戏(整数 %)
							</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label">收益-游戏</label>
							<div class="controls">				
								<input type="text" name="post[income_game]" value="<?php echo ($config['income_game']); ?>"> 收益-游戏(整数 %)
							</div>
						</div>-->
						...
						<div class="control-group">
							<label class="control-label">收益-礼物</label>
							<div class="controls">				
								<input type="text" name="post[income_gift]" value="<?php echo ($config['income_gift']); ?>"> 收益-礼物(整数 %)
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">收益-房间扣费</label>
							<div class="controls">				
								<input type="text" name="post[income_room]" value="<?php echo ($config['income_room']); ?>"> 收益-房间扣费(整数 %)
							</div>
						</div>
                        
                        <div class="control-group">
							<label class="control-label">收益-直播间内红包</label>
							<div class="controls">				
								<input type="text" name="post[income_redenvelopes]" value="<?php echo ($config['income_redenvelopes']); ?>"> 收益-直播间内红包(整数 %)
							</div>
						</div>
                       
						
						<div class="control-group">
							<label class="control-label">收益-直播间内弹幕</label>
							<div class="controls">				
								<input type="text" name="post[income_barrage]" value="<?php echo ($config['income_barrage']); ?>"> 收益-直播间内弹幕(整数 %)
							</div>
						</div>
						
						<!--
						<div class="control-group">
							<label class="control-label">收益-家族</label>
							<div class="controls">				
								<input type="text" name="post[income_family]" value="<?php echo ($config['income_family']); ?>"> 收益-家族(整数 %)
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">收益-分销</label>
							<div class="controls">				
								<input type="text" name="post[income_distribution]" value="<?php echo ($config['income_distribution']); ?>"> 收益-家族(整数 %)
							</div>
						</div>-->
				...
				<div>
					<fieldset>
						<div class="control-group">
							<label class="control-label">挖矿-范围</label>
							<div class="controls">				
								<input type="text" name="post[mining_fanwi]" value="<?php echo ($config['mining_fanwi']); ?>"> 范围（0.01-100）
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">挖矿-用户签到</label>
							<div class="controls">				
								<input type="text" name="post[mining_sign]" value="<?php echo ($config['mining_sign']); ?>"> 挖矿-用户签到 (整数)
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">挖矿-给用户点赞</label>
							<div class="controls">				
								<input type="text" name="post[mining_spotzan]" value="<?php echo ($config['mining_spotzan']); ?>"> 挖矿-点赞人 (整数)
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">挖矿-给用户评论</label>
							<div class="controls">				
								<input type="text" name="post[mining_comment]" value="<?php echo ($config['mining_comment']); ?>"> 挖矿-评论人 (整数)
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">挖矿-收用户点赞</label>
							<div class="controls">				
								<input type="text" name="post[mining_collectzan]" value="<?php echo ($config['mining_collectzan']); ?>"> 挖矿-被点赞人 (整数)
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">挖矿-收用户评论</label>
							<div class="controls">				
								<input type="text" name="post[mining_collectcomment]" value="<?php echo ($config['mining_collectcomment']); ?>"> 挖矿-被评论人 (整数)
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">挖矿-上传视频</label>
							<div class="controls">				
								<input type="text" name="post[mining_uploadvideo]" value="<?php echo ($config['mining_uploadvideo']); ?>"> 挖矿-上传视频 (整数)
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">挖矿-浏览视频</label>
							<div class="controls">				
								<input type="text" name="post[mining_browsevideo]" value="<?php echo ($config['mining_browsevideo']); ?>"> 例:1/1 (权重/分钟 整数)
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">挖矿-送礼物</label>
							<div class="controls">				
								<input type="text" name="post[mining_sendgift]" value="<?php echo ($config['mining_sendgift']); ?>"> 例:10/1 (权重/<?php echo ($config['token_name']); ?> 整数)
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">挖矿-收礼物</label>
							<div class="controls">				
								<input type="text" name="post[mining_gift]" value="<?php echo ($config['mining_gift']); ?>"> 例:1/10 (<?php echo ($config['token_name']); ?>/权重 整数)
							</div>
						</div>
	...
	<script>
					(function(){
						...
						$("input[name='post[withdraw_fee_type]']").on('click',function(){
							  
							 var val = $(this).val();
							 if(val==0)
							 {	
							 	$("input[name='post[min_withdraw_fee]']").removeAttr('readonly');
							 	$("input[name='post[minimum_fee_percentage]']").attr('readonly','readonly');
							 	$("input[name='post[minimum_fee_percentage]']").val(0);	

							 }else{
							 	$("input[name='post[minimum_fee_percentage]']").removeAttr('readonly');
								$("input[name='post[min_withdraw_fee]']").attr('readonly','readonly');
							 	$("input[name='post[min_withdraw_fee]']").val(0);	
							 }
						})
