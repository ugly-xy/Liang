			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td>
						  <?php if($vo['islive'] == '1'): ?>直播中
							<?php else: ?>
							    <?php echo (date("Y-m-d H:i:s",$vo["endtime"])); endif; ?>
						</td>
						<td><?php echo ($vo['nums']); ?></td>
						<!-- <td align="center">	
						 <a href="<?php echo U('Live/edit',array('id'=>$vo['id']));?>" >编辑</a> | 
							<a href="<?php echo U('Live/del',array('id'=>$vo['id']));?>" class="js-ajax-dialog-btn" data-msg="您确定要删除吗？">删除</a>
						</td> -->
