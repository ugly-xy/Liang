...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a >分类修改</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Music/classify_edit_post');?>">
			<fieldset>
				
				<input type="hidden" name="id" value="<?php echo ($classify_info['id']); ?>">
				<div class="control-group">
					<label class="control-label">排序号</label>
					<div class="controls">
						<input type="text" name="orderno" value="<?php echo ($classify_info['orderno']); ?>">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="title" value="<?php echo ($classify_info['title']); ?>">
						<span class="form-required">* 简洁明了</span>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">분류 이름</label>
					<div class="controls">
						<input type="text" name="title_kr" value="<?php echo ($classify_info['title_kr']); ?>">
						<span class="form-required">* 간결하고 깔끔하다.</span>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
								<div >
									<input type="hidden" name="img_url" id="thumb2" value="<?php echo ($classify_info['img_url']); ?>">
									<a href="javascript:void(0);" onclick="flashupload('thumb_images', '附件上传','thumb2',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
										...
										<?php if($classify_info['img_url'] != ''): ?><img src="<?php echo ($classify_info['img_url']); ?>" id="thumb2_preview" width="135" style="cursor: hand" />
