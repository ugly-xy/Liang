...
<body>
	<div class="wrap">
		...
		<form class="well form-search" method="post" action="<?php echo U('Video/passindex');?>">
			排序：
				...
				<tbody>
					...
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td align="center">
							...
							|
							<a href="<?php echo U('Video/edit',array('id'=>$vo['id'],'from'=>'passindex'));?>" >编辑</a>
							 <?php if($vo['isdel'] == '0'): ?>|
							<a href="javascript:void (0)" onclick="xiajia(<?php echo ($vo['id']); ?>)" >下架</a><?php endif; ?>
							 |
							<a href="javascript:void (0)" onclick="commentlists(<?php echo ($vo['id']); ?>)" >评论列表</a></if>
							 |
