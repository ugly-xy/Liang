...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Music/music_edit_post');?>">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="classify_id">
						   ...
						   <?php if(is_array($classify)): $i = 0; $__LIST__ = $classify;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php if($info['classify_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo['title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>			
				...
				<div class="control-group">
					<label class="control-label">음악 이름</label>
					<div class="controls">
						<input type="text" name="title_kr" value="<?php echo ($info['title_kr']); ?>">
						<span class="form-required">*</span>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
								<div >
									<input type="hidden" name="img_url" id="thumb2" value="<?php echo ($info['img_url']); ?>">
									<a href="javascript:void(0);" onclick="flashupload('thumb_images', '附件上传','thumb2',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
										<?php if($info['img_url'] != ''): ?><img src="<?php echo ($info['img_url']); ?>" id="thumb2_preview" width="135" style="cursor: hand" />
										<?php else: ?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="length" name="length" value="<?php echo ($info['length']); ?>" readonly="readonly">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="use_nums" value="<?php echo ($info['use_nums']); ?>">
			...
			<div class="form-actions">
				<button id="submit" type="submit" class="btn btn-primary js-ajax-submit"><?php echo L('EDIT');?></button>
