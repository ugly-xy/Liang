			...
			<div class="js-tabs-content">
				...
				<div>
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label">上架开关</label>
							<div class="controls">			
								<label class="radio inline"><input type="radio" value="1" name="post[shelves_switch]" <?php if(($config['shelves_switch']) == "1"): ?>checked="checked"<?php endif; ?>>是</label>
								<label class="radio inline"><input type="radio" value="0" name="post[shelves_switch]" <?php if(($config['shelves_switch']) == "0"): ?>checked="checked"<?php endif; ?>>否</label>
								<label class="checkbox inline"> 是否正在上架审核中  </label>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">				
								<input type="text" name="post[app_name]" value="<?php echo ($config['app_name']); ?>">App名称
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">				
									<input type="text" name="post[qq]" value="<?php echo ($config['qq']); ?>"> 
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">				
									<input type="text" name="post[times]" value="<?php echo ($config['times']); ?>"> 用户登录过期时间(单位:小时) 当前时间+T（注意：必须大于等于1）
							</div>
						</div>
						<!--
						<div class="control-group">
				...
				<div>
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label">邀请注册分享标题</label>
							<div class="controls">				
								<input type="text" name="post[h5_share_title]" value="<?php echo ($config['h5_share_title']); ?>"> 邀请注册分享话术
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label">邀请注册分享话术</label>
							<div class="controls">				
								<input type="text" name="post[h5_share_des]" value="<?php echo ($config['h5_share_des']); ?>"> 邀请注册分享话术
							</div>
						</div>
					</fieldset>
				</div>
