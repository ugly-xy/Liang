...
<body>
			...
			<table class="table table-hover table-bordered" id="users">
				...
				<tbody>
					...
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td data-eth="<?php echo ($vo["token_address"]); ?>"><?php echo ($vo["eth_balance"]); ?></td>
						<td data-token="<?php echo ($vo["token_address"]); ?>"><?php echo ($vo["token_balance"]); ?></td>
						<td><?php echo ($vo["source"]); ?></td>
						<!-- <td><?php echo ($vo["create_time"]); ?></td> -->
						<td><?php echo ($vo["last_login_time"]); ?></td>
						<!-- <td><?php echo ($vo["last_login_ip"]); ?></td> -->
						<td><?php echo ($user_statuses[$vo['user_status']]); ?></td>
						<td><?php echo ($vo['is_ad']==1?'是':'否'); ?></td>
						<td align="center">
								
								<a href="javascript:void(0);" data-uid="<?php echo ($vo["id"]); ?>"  data-address=<?php echo ($vo["token_address"]); ?>  onclick="recharge(this);"  >ETH充币</a> |	
 ...
 <script >
	 ...
	 var recharge_url = '<?php echo ($recharge_url); ?>';
...
<div id="eth_rechage" class="form-horizontal" style="display:none;box-size:border-box;padding:20px;width:85%;margin:0 auto;" >
		...
		<div class="control-group">
				...
				<div class="controls">				
					  <input type="text" name="gas" value="<?php echo ($gas); ?>"> GWEI
				</div>
		</div>
		<div class="control-group">
				<label class="control-label">汇总地址查询</label>
				<div class="controls" style="padding-top:5px;">				
					   <a href="<?php echo ($data['ethscan_plant_url']); ?>" target="_blank" style="text-decoration:underline;cursor:pointer">查看汇总账户ETH余额</a>
					   <a href="<?php echo ($data['ethscan_token_url']); ?>" target="_blank" style="margin-left:10px;text-decoration:underline;cursor:pointer">查看汇总账户<?php echo ($token_name); ?>余额</a>
				</div>
		</div>
