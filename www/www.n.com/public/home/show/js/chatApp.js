	...
	sendChat: function(){
      ...
      success: function(data)
      {
				...
				else
				{
					...
					{
						var msg = '{"msg":[{"_method_":"SendMsg","action":0,"ct":"'+chatmsg+'","msgtype":"2","tougood":"","touid":"","touname":"","ugood":"'+_DATA.user.id+'","uid":"'+_DATA.user.id+'","uname":"'+_DATA.user.user_nicename+'","level":"'+_DATA.user.level+'","vip_type":"'+ _DATA.user.vip.type +'","liangname":"'+ _DATA.user.liang.name+'","usertype":"'+ _DATA.usertype+'","guard_type":"'+ _DATA.guard_type+'"}],"retcode":"000000","retmsg":"OK"}';
					}
					Socket.emitData('broadcast',msg);		
				}
      }
		...
		$.ajax({
			...
			success:function(data){
				...
				if(data.errno!=0){
					...
					var msg = '{"retcode":"000000","retmsg":"ok","msg":[{"_method_":"SendGift","action":"0","ct":"'+data.gifttoken+'","msgtype":"1","level":"'+data.level+'","uid":"'+data.uid+'","timestamp":"'+WlTools.FormatNowDate()+'","uname":"'+_DATA.user.user_nicename+'","uhead":"'+_DATA.user.avatar+'","vip_type":"'+ _DATA.user.vip.type +'","liangname":"'+ _DATA.user.liang.name+'","usertype":"'+ _DATA.usertype+'","guard_type":"'+ _DATA.guard_type+'"}]}'; 
					Socket.emitData('broadcast',msg);
				}
			},
			error: function(data)
...
var Light={
	...
	light:function()
	{
		...
		{
			 _DATA.user.light=1;
			var msg = '{"retcode":"000000","retmsg":"ok","msg":[{"_method_":"SendMsg","action":"0","msgtype":"2","level":"'+_DATA.user.level+'","uname":"'+_DATA.user.user_nicename+'","uid":"'+_DATA.user.id+'","heart":"1","ct":"我点亮了","vip_type":"'+ _DATA.user.vip.type +'","liangname":"'+ _DATA.user.liang.name+'","usertype":"'+ _DATA.usertype+'","guard_type":"'+ _DATA.guard_type+'"}]}';
			Socket.emitData('broadcast',msg);
		}
		/* if(time<=timestamp)
		{	
