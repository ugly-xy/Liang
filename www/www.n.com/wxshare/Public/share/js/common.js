		...
		$.ajax({
            ...
            success:function(data){
				...
				if(data.errno==0){
					...
					var msg = '{"retcode":"000000","retmsg":"ok","msg":[{"_method_":"SendGift","action":"0","ct":"'+data.gifttoken+'","msgtype":"1","level":"'+data.level+'","uid":"'+data.uid+'","uname":"'+User.user_nicename+'","uhead":"'+User.avatar+'","vip_type":"'+ User.vip.type +'","liangname":"'+ User.liang.name+'"}]}'; 
					Socket.emitData('broadcast',msg);
				}else{
					_this.countdown_hide();
