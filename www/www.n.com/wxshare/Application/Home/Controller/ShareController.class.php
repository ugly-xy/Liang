...
/* 	$user_login!=$_SESSION['mobile'] */
	...
	public function sendGift(){
		...
		$result=array("uid"=>(int)$uid,"giftid"=>(int)$giftid,"type"=>$giftinfo['type'],"giftcount"=>(int)$giftcount,"totalcoin"=>$total,"giftname"=>$giftinfo['giftname'],"gifticon"=>get_upload_path($giftinfo['gifticon']),"swftime"=>$giftinfo['swftime'],"swf"=>$swf,"level"=>$level,"votestotal"=>$liveuid_info['votestotal']);
